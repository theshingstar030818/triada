...
- [Demo 1](https://experiments.muditameta.com/fuzzyDropdown/)
- [Demo 2](https://experiments.muditameta.com/fuzzyDropdown2/)
...
//via jquery plugins
//goto: https://plugins.jquery.com/fuzzyDropdown and download it from there.
